...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/create-e252d1c1.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5acedaf3.mjs').then((m) => m.default || m)
  },
  {
    name: "p-id",
    path: "/p/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-c8a53be7.mjs').then((m) => m.default || m)
  },
  {
    name: "signup",
    path: "/signup",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/signup-606577fa.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/todososprojetos-fcae3263.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-3b8a75ad.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-729e9aff.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRoute as a, useRuntimeConfig as b, createError as c, useNuxtApp as d, entry$1 as default, asyncDataDefaults as e, fetchDefaults as f, navigateTo as g, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
